...
FOCUSED_CRATES := use-cve use-cwe use-cvss use-owasp use-security-risk use-threat use-security-finding use-authn use-authz use-secret use-crypto use-security-header use-sbom
FACADE_CRATE := use-security
